# LMS Vertical Slice Index

**Project:** Learning Management System (LMS)
**Document Type:** Vertical Slice Development Index
**Date:** 29 June 2026
**Stack:** Next.js (Vercel) + Supabase (PostgreSQL + Auth + Storage)
**Total Slices:** 42 (21 Backend + 21 Frontend)

---

## How to Read This Document

Each slice is a complete, independently deliverable unit of work.

- **Backend Slice (BE):** Supabase SQL migrations + RLS policies + Vercel Function (only when needed)
- **Frontend Slice (FE):** Next.js screens + Supabase client calls + E2E manual test description

Two developers work in parallel. Backend developer picks a BE slice. Frontend developer picks the matching FE slice using mock data. They integrate once both slices are marked Done.

**Definition of Done:**
- **Backend:** Migration runs clean + RLS policies tested + integration test passes
- **Frontend:** Screen renders + Supabase client wired + E2E manual test steps verified

---

## Custom Vercel API Routes (5 total)

| Route | Purpose | Used By |
|---|---|---|
| POST /api/notify | SMS / WhatsApp / Email dispatch via MSG91 | BE-16 |
| POST /api/payment/webhook | Razorpay webhook handler | BE-15 |
| POST /api/ai/analyze | AI weak-topic and prediction analysis | BE-18 |
| POST /api/sync | Offline sync conflict resolution | BE-21 |
| POST /api/report/generate | PDF / Excel report generation | BE-19 |
...
- Phase 1: BE-01 then BE-02, BE-03, BE-04
- Phase 2: BE-05 (needs BE-02, BE-03)
- Phase 3: BE-06 to BE-10 (all need BE-05)
- Phase 4: BE-11 to BE-14 (need BE-09)
- Phase 5: BE-15 to BE-17 (need BE-05)
- Phase 6: BE-18, BE-19 (need BE-06, BE-14, BE-15)
- Phase 7: BE-20, BE-21 (need BE-06, BE-12)

Frontend slices start with mock data immediately. Real wiring follows backend slice completion.

---

## Summary Table

| Phase | BE Slices | FE Slices | Total |
|---|---|---|---|
| Phase 1 - Foundation | 4 | 4 | 8 |
| Phase 2 - Course Infrastructure | 1 | 1 | 2 |
| Phase 3 - Academic Operations | 5 | 5 | 10 |
| Phase 4 - Examinations | 4 | 4 | 8 |
| Phase 5 - Finance and Comms | 3 | 3 | 6 |
| Phase 6 - Intelligence and Reporting | 2 | 2 | 4 |
| Phase 7 - Offline and Sync | 2 | 2 | 4 |
| **Total** | **21** | **21** | **42** |

---

## Complete Slice Reference

| Slice ID | Name | Phase | Type | Vercel Function |
|---|---|---|---|---|
| BE-01 | Auth and RBAC | 1 | Backend | None |
| FE-01 | Auth and Login Screens | 1 | Frontend | None |
| BE-02 | Student Admission and Profile | 1 | Backend | None |
| FE-02 | Student Registration Screens | 1 | Frontend | None |
| BE-03 | Faculty Management | 1 | Backend | None |
| FE-03 | Faculty Management Screens | 1 | Frontend | None |
| BE-04 | Parent Portal and Mapping | 1 | Backend | None |
| FE-04 | Parent Portal Screens | 1 | Frontend | None |
| BE-05 | Course and Batch Management | 2 | Backend | None |
| FE-05 | Course and Batch Screens | 2 | Frontend | None |
| BE-06 | Attendance Daily and Online | 3 | Backend | None |
| FE-06 | Attendance Marking Screens | 3 | Frontend | None |
| BE-07 | Attendance QR and Offline | 3 | Backend | None |
| FE-07 | QR Attendance Screens | 3 | Frontend | None |
| BE-08 | Live Classes and Recordings | 3 | Backend | None |
| FE-08 | Live Classes Screens | 3 | Frontend | None |
| BE-09 | Syllabus Management | 3 | Backend | None |
| FE-09 | Syllabus Screens | 3 | Frontend | None |
| BE-10 | Homework and Assignments | 3 | Backend | None |
| FE-10 | Homework Screens | 3 | Frontend | None |
| BE-11 | Test Creation and Publishing | 4 | Backend | None |
| FE-11 | Test Creation Screens | 4 | Frontend | None |
| BE-12 | MCQ Online Test Engine | 4 | Backend | None |
| FE-12 | Student Test Attempt Screens | 4 | Frontend | None |
| BE-13 | Subjective and OMR Evaluation | 4 | Backend | None |
| FE-13 | Evaluation Screens | 4 | Frontend | None |
| BE-14 | Results Ranks and Topper List | 4 | Backend | None |
| FE-14 | Results and Ranks Screens | 4 | Frontend | None |
| BE-15 | Fees Management | 5 | Backend | /api/payment/webhook |
| FE-15 | Fees Screens | 5 | Frontend | None |
| BE-16 | Notification System | 5 | Backend | /api/notify |
| FE-16 | Notification Screens | 5 | Frontend | None |
| BE-17 | Calendar and Meetings | 5 | Backend | None |
| FE-17 | Calendar Screens | 5 | Frontend | None |
| BE-18 | AI and Analytics Engine | 6 | Backend | /api/ai/analyze |
| FE-18 | Analytics Dashboard Screens | 6 | Frontend | None |
| BE-19 | Reports and Activity Logs | 6 | Backend | /api/report/generate |
| FE-19 | Reports Screens | 6 | Frontend | None |
| BE-20 | PWA and Cache Strategy | 7 | Backend | None |
| FE-20 | Offline UI and Sync Screens | 7 | Frontend | None |
| BE-21 | Offline Sync Engine | 7 | Backend | /api/sync |
| FE-21 | PWA Install Flow | 7 | Frontend | None |
